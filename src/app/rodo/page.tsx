...
import { Shield } from "lucide-react";import { getAssetPath } from "@/utils/assetPath";
        ...
        <main className="min-h-screen bg-white dark:bg-slate-950 transition-colors duration-300">
            ...
            <section className="relative h-[40vh] md:h-[50vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-20 text-center text-white p-4 mt-16">
                    ...
                    <h1 className="text-4xl md:text-6xl font-sans mb-4">Klauzula informacyjna (RODO)</h1>
                </div>
            </section>
