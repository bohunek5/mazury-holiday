...
export default function CharterPage() {
    ...
    const galleryImages = czarterData.images || [];
        ...
        <main className="min-h-screen bg-white dark:bg-slate-950 transition-colors duration-300 pb-24 lg:pb-0">
            ...
            <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-20 text-center text-white p-4">
                    <div className="inline-block bg-amber-500 text-white px-4 py-1.5 rounded-full text-sm font-bold uppercase tracking-wider shadow-lg mb-4">{t("apartments", "items.stranda.location") as string || "Port Stranda Giżycko, jezioro Kisajno"}</div>
                        ...
                        <div className="sticky top-32 space-y-8">
                            ...
                            <div className="bg-slate-900 text-white p-8 rounded-3xl shadow-2xl relative overflow-hidden transform transition-all hover:scale-[1.02]">
                                ...
                                <div className="flex gap-2">
                                    <a
                                        href={`https://engine37851.idobooking.com/index.php?ob[${czarterData.idoBookingId}]=&showOtherOffers=true&currency=0&language=0&from_own_button=1`}
                                        target="_blank"
