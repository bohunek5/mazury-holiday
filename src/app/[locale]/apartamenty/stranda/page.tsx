        ...
        <main className="min-h-screen bg-white dark:bg-slate-950 transition-colors duration-300">
            ...
            <section className="py-20 px-4 md:px-8 max-w-7xl mx-auto">
                ...
                <div className="mb-16 max-w-5xl mx-auto">
                    <h2 className="text-xl md:text-2xl font-bold uppercase tracking-widest text-slate-700 dark:text-slate-300 mb-6 text-center">Lokalizacja budynków</h2>
                    <StrandaMap />
                </div>
                                                    ...
                                                    >
                                                        <div className="relative h-64 w-full overflow-hidden">
                                                            ...
                                                            <div className="absolute top-4 left-4 bg-amber-500 text-white px-4 py-1.5 rounded-full text-sm font-bold uppercase tracking-wider shadow-lg">
                                                                {(unit.id.toLowerCase() === 'studio' || unit.id.toLowerCase() === 'c-z-dwoma-sypialniami') ? 'C' : unit.id.toUpperCase().replace(/-/g, ' ')}
                                                            </div>
                                                            ...
                                                            <div className="absolute bottom-4 left-5 text-white pr-4">
                                                                <h3 className="text-lg md:text-xl font-bold font-sans">
                                                                    {(() => {
                                                                        ...
                                                                        if (typeLow.includes('twobedroom') || titleLow.includes('dwoma sypialniami') || titleLow.includes('2 sypialni') || titleLow.includes('2 sypialniach') || descLow.includes('dwoma sypialniami') || descLow.includes('2 sypialnie') || descLow.includes('2 sypialni') || descLow.includes('dwie sypialnie')) {
                                                                            features.push('2 sypialnie');
                                                                        } else if (typeLow.includes('onebedroom') || titleLow.includes('jedną sypialnią') || titleLow.includes('1 sypialni') || descLow.includes('jedną sypialnią') || descLow.includes('1 sypialnią') || descLow.includes('sypialnię')) {
