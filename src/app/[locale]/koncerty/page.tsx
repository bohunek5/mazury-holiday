        ...
        <main className="min-h-screen bg-white dark:bg-slate-950 transition-colors duration-300">
            ...
            <section className="relative h-[40vh] md:h-[60vh] flex items-center justify-center overflow-hidden">
                ...
                <Image
                    ...
                    quality={80}
                />
                <div className="relative z-10 text-center text-white p-4 max-w-4xl mx-auto mt-20 md:mt-0">
                    <motion.div
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.8 }}
                    >
                        <div className="inline-flex items-center justify-center p-2 md:p-3 bg-amber-500 rounded-full mb-4 md:mb-6 shadow-xl">
                            <Music className="w-5 h-5 md:w-8 md:h-8 text-white" />
                        </div>
                        <h1 className="text-3xl md:text-7xl font-sans font-bold mb-4 md:mb-6">Koncerty w Porcie Stranda</h1>
