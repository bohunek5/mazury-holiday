                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="space-y-8">
                        <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl shadow-xl border border-slate-100 dark:border-slate-800 sticky top-24">
                            ...
                            <a href="tel:666666666" className="block w-full bg-[#50B848] hover:bg-[#45a041] text-white text-center font-bold py-4 rounded-xl mt-8 transition-colors shadow-lg hover:shadow-green-500/30 uppercase tracking-widest">
