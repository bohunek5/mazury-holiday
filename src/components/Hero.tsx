  ...
  return (
    <section className="relative h-screen min-h-[600px] flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 px-4 text-center text-white mt-0 md:-mt-12 flex flex-col items-center">
        ...
        <div className="w-24 h-1 bg-amber-500 mx-auto mb-2 rounded-full shadow-lg" />

        <p className="text-sm md:text-base lg:text-lg font-bold tracking-[0.2em] mb-2 text-white max-w-4xl mx-auto uppercase [text-shadow:_0_4px_12px_rgba(0,0,0,0.9)] leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6 mt-0 sm:mt-6 w-full">
          <a
        ...
        <div className="mt-4 z-30 pointer-events-auto flex justify-center w-full md:hidden">
          <button 
            onClick={() => {
            ...
            className="flex flex-col items-center justify-center gap-1.5 animate-bounce-slow cursor-pointer hover:opacity-80 transition-opacity w-full"
          >
            <Sun className="w-8 h-8 text-amber-500 animate-spin-slow-pause mx-auto drop-shadow-md" />
            <span className="text-white text-xs font-black tracking-[0.2em] uppercase whitespace-nowrap [text-shadow:_0_4px_16px_rgba(0,0,0,1),_0_2px_4px_rgba(0,0,0,0.8)] text-center w-full">
