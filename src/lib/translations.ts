export const translations = {
    pl: {
        ...
        apartments: {
            ...
            people: "osoby",
            items: {
                stranda: { title: "Apartamenty Stranda Residence (Giżycko)", location: "Port Stranda, Giżycko", description: "Apartamenty znajdują się przy porcie Stranda na terenie kompleksu apartamentowców Stranda Residence..." },
...
Polecany rodzinom z dziećmi, wędkarzom, grzybiarzom i miłośnikom natury.`,
            ...
            callBtn: "Zadzwoń: +48 730 067 027",
    ...
    de: {
        ...
        pokojeFuledaPage: {
            ...
            callBtn: "Anrufen: +48 730 067 027",
    ...
    cs: {
        ...
        pokojeFuledaPage: {
            ...
            callBtn: "Volejte: +48 730 067 027",
    ...
    lt: {
        ...
        pokojeFuledaPage: {
            ...
            callBtn: "Skambinti: +48 730 067 027",
