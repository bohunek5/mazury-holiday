...
ZIP_PATH = "/Users/karolbohdanowicz/my-ai-agents/mazury-holiday/deploy_specific_apts.zip"
DIRS_TO_UPLOAD = [
    "/Users/karolbohdanowicz/my-ai-agents/mazury-holiday/public/images/stranda/B304",
    "/Users/karolbohdanowicz/my-ai-agents/mazury-holiday/public/images/stranda/C_Studio",
    "/Users/karolbohdanowicz/my-ai-agents/mazury-holiday/public/images/stranda/C205"
]

print("📦 Zipping specific directories...")
        ...
        for root, dirs, files in os.walk(dir_path):
            for file in files:
                if not file.startswith('.'):
                    ...
                    # Arcname must be "images/..."
                    rel_path = "images/" + os.path.relpath(full_path, "/Users/karolbohdanowicz/my-ai-agents/mazury-holiday/public/images")
...
if resp.status_code == 200 and "ok" in resp.text:
    print("✅ Specific apartments deployed!")
else:
